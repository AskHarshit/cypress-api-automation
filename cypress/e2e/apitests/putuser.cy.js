...
const dataJson = require('../../fixtures/createuser')
    ...
    describe('post user request',()=>{
        ...
        it('create user test then change few values using put then check the same values using get',()=>{
            ...
            cy.request({
                ...
                const userId = resp.body.id
                    ...
                    cy.request({
                        ...
                        body: {
                            "name":"Test Automation through put call",
                            "gender":"male",
                            "email":testEmail,
                            "status":"active"
                            }
                        ...
                        expect(resp.body).has.property('name',"Test Automation through put call")
